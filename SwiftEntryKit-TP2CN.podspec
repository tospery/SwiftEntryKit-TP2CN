...
Pod::Spec.new do |s|
  s.name = 'SwiftEntryKit-TP2CN'
  s.version = '1.2.7-tp2cn-v1'
...
DESC
  s.homepage         = 'https://github.com/tospery/SwiftEntryKit-TP2CN'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'YangJianxiang' => 'tospery@gmail.com' }
  s.source           = { :git => 'https://github.com/tospery/SwiftEntryKit-TP2CN.git', :tag => s.version.to_s }
